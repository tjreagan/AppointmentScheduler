...
public class UpdateAppointmentController implements Initializable {
    ...
    @FXML
    private TextField currentAppointmentStartTextField;

    @FXML
    private TextField currentAppointmentEndTextField;

    private static Appointment appointmentToUpdate = MainViewController.appointmentToUpdate;

    //Used lambda to reduce the clutter of repetitive alert popup code.
    ...
    //Used lambda to reduce the clutter of repetitive scene changing code.
    ...
    public void save(ActionEvent event) throws IOException {
        ...
        if (customerIDTextField.getText().isEmpty() || consultantIDTextField.getText().isEmpty() || typeTextField.getText().isEmpty() || startTimeComboBox.getSelectionModel().isEmpty() || endTimeComboBox.getSelectionModel().isEmpty() || dateSelector.getValue() == null) {
            ...
            try {
                ...
                if(rs.isBeforeFirst() && rs.next() && rs.isFirst() && rs.isLast()) {
                    ...
                    appointmentToUpdate.setStart(sdt);
                    appointmentToUpdate.setEnd(edt);
                    appointmentToUpdate.setType(type);
                    appointmentToUpdate.setUserId(consultantId);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        currentAppointmentStartTextField.setText(appointmentToUpdate.getDisplayAppointmentStartTime().toString());
        currentAppointmentEndTextField.setText(appointmentToUpdate.getDisplayAppointmentEndTime().toString());
        customerIDTextField.setText(String.valueOf(appointmentToUpdate.getCustomerId()));
        consultantIDTextField.setText(String.valueOf(appointmentToUpdate.getUserId()));
